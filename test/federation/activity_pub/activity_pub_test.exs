...
defmodule Pleroma.Federation.ActivityPubTest do
  ...
  describe "uploading files" do
    test "copies the file to the configured folder" do
      ...
      {:ok, %Object{} = object} =
        ActivityPub.upload(file, uploader: Pleroma.Upload.Uploader.Local)
    ...
    test "works with base64 encoded images" do
      ...
      {:ok, %Object{}} = ActivityPub.upload(file, uploader: Pleroma.Upload.Uploader.Local)
    end
  end
  ...
  describe "update" do
    test "it creates an update activity with the new user data" do
      ...
      user_data = UserView.render("user.json", %{user: user})
