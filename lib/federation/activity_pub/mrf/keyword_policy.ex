...
defmodule Pleroma.Federation.ActivityPub.MRF.KeywordPolicy do
  ...
  defp check_ftl_removal(
    ...
    if Constants.as_public() in to and
         Enum.any?(Pleroma.Config.get([:mrf_keyword, :federated_timeline_removal]), fn pattern ->
           string_matches?(content, pattern) or string_matches?(summary, pattern)
         end) do
      to = List.delete(to, Constants.as_public())
      cc = [Constants.as_public() | message["cc"] || []]
