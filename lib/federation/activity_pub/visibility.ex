...
defmodule Pleroma.Federation.ActivityPub.Visibility do
  ...
  def is_public?(data), do: Utils.label_in_message?(Constants.as_public(), data)
  ...
  def get_visibility(object) do
    ...
    cond do
      Constants.as_public() in to ->
        "public"

      Constants.as_public() in cc ->
        "unlisted"
