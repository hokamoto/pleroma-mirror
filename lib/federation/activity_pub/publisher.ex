...
defmodule Pleroma.Federation.ActivityPub.Publisher do
  @moduledoc """
  ...
  """
  @callback is_representable?(Activity.t()) :: boolean()
  ...
  """
  @callback gather_node_info_protocol_names() :: list()

  @spec gather_node_info_protocol_names() :: list()
  def gather_node_info_protocol_names do
    Config.get([:instance, :federation_publisher_modules])
    |> Enum.reduce([], fn module, links ->
      links ++ module.gather_node_info_protocol_names()
    end)
  end
