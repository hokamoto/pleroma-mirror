...
defmodule Pleroma.Federation.ActivityPub.MRF.SimplePolicy do
  ...
  defp check_ftl_removal(%{host: actor_host} = _actor_info, object) do
    ...
    object =
      with true <- MRF.subdomain_match?(timeline_removal, actor_host),
           ...
           true <- Constants.as_public() in object["to"] do
        to = List.delete(object["to"], Constants.as_public()) ++ [user.follower_address]

        cc = List.delete(object["cc"], user.follower_address) ++ [Constants.as_public()]
