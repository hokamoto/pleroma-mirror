...
- Refactoring: Introduced `Pleroma.Federation` context for federation related modules: `OStatus`, `ActivityPub`, `HTTPSignatures`, `WebFinger` and `NodeInfo`.
- Refactoring: Clarified boundaries between `Pleroma` and `Pleroma.Web` contexts.
