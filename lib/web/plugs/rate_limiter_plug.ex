...
defmodule Pleroma.Web.RateLimiterPlug do
  @moduledoc """
  ...
  * `foobar` which is disabled
  ...
  AllowedSyntax:
      ...
      plug(Pleroma.Web.RateLimiterPlug, name: :limiter_name)
      plug(Pleroma.Web.RateLimiterPlug, options)   # :name is a required option
  ...
  Inside a controller:
      ...
      plug(Pleroma.Web.RateLimiterPlug, [name: :one] when action == :one)
      plug(Pleroma.Web.RateLimiterPlug, [name: :two] when action in [:two, :three])

      plug(
        Pleroma.Web.RateLimiterPlug,
  ...
  or inside a router pipeline:
      ...
      pipeline :api do
        ...
        plug(Pleroma.Web.RateLimiterPlug, name: :one)
        ...
      end
  """
  ...
  alias Pleroma.Web.RateLimiter.LimiterSupervisor
  alias Pleroma.User
  ...
  def disabled? do
    ...
    remote_ip_disabled = not Pleroma.Config.get([Pleroma.Web.RemoteIPPlug, :enabled])
