...
defmodule Pleroma.Storage.PageTest do
  ...
  describe "keyset" do
    ...
    test "paginates by min_id", %{notes: notes} do
      ...
      %{total: total, items: paginated} =
        Page.fetch_paginated(Object, %{"min_id" => id, "total" => true})
    ...
    test "paginates by since_id", %{notes: notes} do
      ...
      %{total: total, items: paginated} =
        Page.fetch_paginated(Object, %{"since_id" => id, "total" => true})
    ...
    test "paginates by max_id", %{notes: notes} do
      ...
      %{total: total, items: paginated} =
        Page.fetch_paginated(Object, %{"max_id" => id, "total" => true})
    ...
    test "paginates by min_id & limit", %{notes: notes} do
      ...
      paginated = Page.fetch_paginated(Object, %{"min_id" => id, "limit" => 1})
  ...
  describe "offset" do
    ...
    test "paginates by limit" do
      paginated = Page.fetch_paginated(Object, %{"limit" => 2}, :offset)

      assert length(paginated) == 2
    end

    test "paginates by limit & offset" do
      paginated = Page.fetch_paginated(Object, %{"limit" => 2, "offset" => 4}, :offset)
